...
for(var i =0 ; i<productContainer.length;i++){
  ...
  if(productContainer[i].pname.toLowerCase().includes(searchValue.value.toLowerCase()) || productContainer[i].price.toLowerCase().includes(searchValue.value.toLowerCase()) || productContainer[i].category.toLowerCase().includes(searchValue.value.toLowerCase()) || productContainer[i].desc.toLowerCase().includes(searchValue.value.toLowerCase()))
  {
    trs +=`<tr>
    <td>${i+1}</td>
    <td>${productContainer[i].pname}</td>
